...
if (isset($_POST["update_user"])) {
    ...
    $query = "UPDATE user SET username='$username',name='$name',lastname='$lastname', password='$password', email='$email', role='$role' 
    WHERE id='$id'";
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <input type="hidden" name="id" value="<?=$user['id'];?>">   
                                                        ...
                                                        <div class="col-md-5 px-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="username" class="form-control" placeholder="Kullanıcı Adı" value="<?php echo $user['username']; ?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 pl-1">
                                                            <div class="form-group">
                                                                <label>Soyisim</label>
                                                                <input type="text" class="form-control" name="lastname" placeholder="Soyisim" value="<?php echo $user['lastname']; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
